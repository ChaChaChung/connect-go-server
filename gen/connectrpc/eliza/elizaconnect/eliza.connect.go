...
import (
	...
	context "context"
	errors "errors"
	eliza "myapp/backend/gen/connectrpc/eliza"
	http "net/http"
	strings "strings"
)
...
func NewElizaServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ElizaServiceClient {
	...
	elizaServiceMethods := eliza.File_connectrpc_eliza_eliza_proto.Services().ByName("ElizaService").Methods()
	return &elizaServiceClient{
		...
		getRandomPerson: connect.NewClient[eliza.GetRandomPersonRequest, eliza.GetRandomPersonResponse](
			httpClient,
...
func (c *elizaServiceClient) GetRandomPerson(ctx context.Context, req *connect.Request[eliza.GetRandomPersonRequest]) (*connect.Response[eliza.GetRandomPersonResponse], error) {
