...
import (
	...
	context "context"
	errors "errors"
	v1 "myapp/backend/gen/connectrpc/eliza/v1"
	http "net/http"
	strings "strings"
)
...
type ElizaServiceClient interface {
	...
	GetRandomPerson(context.Context, *connect.Request[v1.GetRandomPersonRequest]) (*connect.Response[v1.GetRandomPersonResponse], error)
}
...
func NewElizaServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ElizaServiceClient {
	...
	elizaServiceMethods := v1.File_proto_connectrpc_eliza_eliza_proto.Services().ByName("ElizaService").Methods()
	return &elizaServiceClient{
		...
		getRandomPerson: connect.NewClient[v1.GetRandomPersonRequest, v1.GetRandomPersonResponse](
			httpClient,
			baseURL+ElizaServiceGetRandomPersonProcedure,
...
type elizaServiceClient struct {
	...
	getRandomPerson *connect.Client[v1.GetRandomPersonRequest, v1.GetRandomPersonResponse]
}
...
// GetRandomPerson calls connectrpc.eliza.v1.ElizaService.GetRandomPerson.
func (c *elizaServiceClient) GetRandomPerson(ctx context.Context, req *connect.Request[v1.GetRandomPersonRequest]) (*connect.Response[v1.GetRandomPersonResponse], error) {
...
func NewElizaServiceHandler(svc ElizaServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	elizaServiceGetRandomPersonHandler := connect.NewUnaryHandler(
		ElizaServiceGetRandomPersonProcedure,
		svc.GetRandomPerson,
		connect.WithSchema(elizaServiceMethods.ByName("GetRandomPerson")),
		connect.WithHandlerOptions(opts...),
	)
...
func (UnimplementedElizaServiceHandler) GetRandomPerson(context.Context, *connect.Request[v1.GetRandomPersonRequest]) (*connect.Response[v1.GetRandomPersonResponse], error) {
